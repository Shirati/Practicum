...
public partial class PracShiratiHodContext : DbContext
{
    public PracShiratiHodContext()
    {
    }

    public PracShiratiHodContext(DbContextOptions<PracShiratiHodContext> options)
        : base(options)
    {
    }
